...
void main() {
  group('BatchedASTProcessor Error Handling', () {
    ...
    group('Input Validation', () {
      test(
        'should throw BatchValidationError for empty document list',
        () {
      ...
      test(
        'should throw BatchValidationError for empty transformer list',
        () {
      ...
      test(
        'should throw BatchValidationError for document with no definitions',
        () {
    ...
    group('Fragment Processing Errors', () {
      ...
      test(
        'should throw BatchValidationError for fragment with empty name',
        () async {
    ...
    group('Performance Metrics', () {
      test('should track comprehensive performance metrics', () async {
        ...
        expect(
          metrics,
          containsPair('transformerUsage', isA<Map<String, int>>()),
        );
      });
      ...
      test('should track transformer usage statistics', () async {
        ...
        final metrics = processor.getPerformanceMetrics();
        final transformerUsage = Map<String, dynamic>.from(
          metrics['transformerUsage'] as Map,
        );
    ...
    group('Error Context Information', () {
      test('should provide detailed error context in exceptions', () {
        expect(
